                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(left: 20, bottom: 20, child: Text("data")),
                      ],
                    ),
                    Gap(height: 20),
                    AppText(
                    ...
                    Row(
                      children: [
                        AppText(text: "\$90", color: Colors.red,decoration: TextDecoration.lineThrough,decorationColor: Colors.red,  fontSize: 18,),
                        Gap(width: 10),
                        AppText(
                          text: "\$80",
                          fontSize: 24,
